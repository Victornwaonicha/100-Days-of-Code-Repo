...
# Home view function
@bot_1.route('/', methods=['GET', 'POST'])
@bot_1.route('/index', methods=['GET', 'POST'])
@login_required
def index():
    # user = {'username': 'Mallo'}
    form = PostForm()
    ...
    posts = db.paginate(current_user.following_posts(), page=page,
                        per_page=bot_1.config['POSTS_PER_PAGE'], error_out=False)
...
def user(username):
    ...
    posts = db.paginate(query, page=page,
                        per_page=bot_1.config['POSTS_PER_PAGE'],
                        error_out=False)
...
@bot_1.route('/reset_password_request', methods=['GET', 'POST'])
...
@bot_1.route('/reset_password/<token>', methods=['GET', 'POST'])
